...
# BiBit algorithm
# Single dataset
#listModels = Biclustering.bibit(dataset, cMnr=2, cMnc=2, mode=3, deviceCount=1, debug = True)

# List of datasets (bs.binarizeLevels function)
#listModels = Biclustering.bibit(listDatasets, cMnr=2, cMnc=2, mode=3, deviceCount=1, debug = True)
